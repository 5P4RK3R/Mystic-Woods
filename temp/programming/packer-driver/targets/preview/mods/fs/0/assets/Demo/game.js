        ...
        (function () {
          ...
          preload.prototype = {
            preload: function preload() {
              ...
              game.load.setPreloadSprite(loadingBar); // load title screen
              ...
              game.load.image("gameover", "assets/sprites/game-over.png"); // tileset
              ...
              game.load.tilemap("map", "assets/maps/map.json", null, Phaser.Tilemap.TILED_JSON); // atlas

              game.load.atlasJSONArray("atlas", "assets/atlas/atlas.png", "assets/atlas/atlas.json");
              game.load.atlasJSONArray("atlas-props", "assets/atlas/atlas-props.png", "assets/atlas/atlas-props.json"); // images

              game.load.image('exit', 'assets/environment/exit-open.png'); // audio
          ...
          titleScreen.prototype = {
            create: function create() {
              ...
              tween.to({
                y: 130 + 10
              }, 800, Phaser.Easing.Linear.In).yoyo(true).loop();
              tween.start(); //
          ...
          playGame.prototype = {
            ...
            createExit: function createExit(x, y) {
            ...
            prepareAttack: function prepareAttack() {
              if (attackFlag == 0) {
                attackFlag = 1;
              }
            },
            releaseAttack: function releaseAttack() {
              if (attackFlag == 1) {
            ...
            createTileMap: function createTileMap() {
              ...
              this.layer2 = globalMap.createLayer("Tile Layer 2"); // collisions

              globalMap.setCollision([0, 1]);
              this.layer.resizeWorld();
              this.layer2.resizeWorld();
              this.layer_collisions.resizeWorld(); // this.layer_collisions.visible = true;
            ...
            createMoles: function createMoles() {
            ...
            createTreants: function createTreants() {
            ...
            update: function update() {
              ...
              if (player.alive) {
                ...
                game.physics.arcade.overlap(player, loot_group, this.lootManager, null, this); // exit game if key is obtained

                game.physics.arcade.overlap(player, exit, this.exitManager, null, this);
              }

              this.movePlayer(); //this.debugGame();

              this.hurtManager();
            },
            exitManager: function exitManager(player, exit) {
              if (kills <= 0) {
                this.game.state.start("GameOver");
                this.music.stop();
              }
            },
            lootManager: function lootManager(player, loot) {
              if (loot.type == "gem") {
                this.audioItem.play();
                loot.kill();
            ...
            shotImpact: function shotImpact(enemy, shot) {
              enemy.kill();
              shot.destroy();
              kills--;
              this.audioEnemyDeath.play();
              this.spawnCoin(enemy.x / 16, enemy.y / 16);
              this.spawnEnemyDeath(enemy.position.x, enemy.position.y); // sometimes drop gems or coins
            ...
            spawnGem: function spawnGem(x, y) {
            ...
            renderGroup: function renderGroup(member) {
          ...
          Player = function Player(game, x, y) {
            ...
            this.body.setSize(6, 10, 13, 20); //add animations
            ...
            var attack_side = this.animations.add('attack-side', Phaser.Animation.generateFrameNames('attack-weapon/hero-attack-side/hero-attack-side-weapon-', 1, 3, '', 0), animVel, false); // set flag to false on complete
          ...
          Mole = function Mole(game, x, y, verticalMove) {
            x *= 16;
            y *= 16;
            var vel = 8;
          ...
          Treant = function Treant(game, x, y) {
            x *= 16;
            y *= 16;
            var vel = 8;
          ...
          Arrow = function Arrow(game, x, y, dir) {
          ...
          EnemyDeath.prototype.constructor = EnemyDeath; // Gem

          Gem = function Gem(game, x, y) {
            x *= 16;
            y *= 16;
          ...
          Gem.prototype.constructor = Gem; // COIN

          Coin = function Coin(game, x, y) {
            x *= 16;
            y *= 16;
